...
reportgenerator "-title:Market Library Unit Test Coverage Report (Linux)" "-reports:**/coverage_linux.info" "-targetdir:docs/coveragereportliblinux" "-reporttypes:Html" 

"-sourcedirs:src/utility/src;src/utility/header;src/market/src;src/market/header;src/marketapp/src;src/marketapp/header;src/tests/utility;src/tests/market" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_linux"
