...
call reportgenerator "-title:Market Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:Market Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for Market
call OpenCppCoverage.exe --export_type=binary:market_tests_unit_win.cov --sources src\market\src --sources src\market\header --sources src\tests\market -- build_win\build\Debug\market_tests.exe

echo Generate Test Coverage Data for Market App and Combine Results
call OpenCppCoverage.exe --input_coverage=utility_tests_unit_win.cov --input_coverage=market_tests_unit_win.cov --export_type=cobertura:marketapp_unit_win_cobertura.xml --sources src\utility\src --sources src\utility\header --sources src\market\src --sources src\market\header --sources src\marketapp\src --sources src\marketapp\header --sources src\tests\utility --sources src\tests\market -- build_win\build\Debug\marketapp.exe

echo Generate Unit Test Coverage Report
call reportgenerator "-title:Market Library Unit Test Coverage Report (Windows)" "-targetdir:docs/coveragereportlibwin" "-reporttypes:Html" "-reports:**/marketapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/market/src;src/market/header;src/marketapp/src;src/marketapp/header;src/tests/utility;src/tests/market" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_win"
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/marketapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/market/src;src/market/header;src/marketapp/src;src/marketapp/header;src/tests/utility;src/tests/market" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
call robocopy src\market\header "build_win\build\Release" /E
call robocopy src\marketapp\header "build_win\build\Release" /E
...
call robocopy src\market\header "build_win\build\Debug" /E
call robocopy src\marketapp\header "build_win\build\Debug" /E
